...
(function () {
    ...
    var Swiper = function (container, params) {
        ...
        s.classNames.push('container-' + s.params.direction);
        
        if (s.params.freeMode) {
            s.classNames.push('container-free-mode');
        }
        if (!s.support.flexbox) {
            s.classNames.push('container-no-flexbox');
            s.params.slidesPerColumn = 1;
        }
        if (s.params.autoHeight) {
            s.classNames.push('container-autoheight');
        }
        ...
        if (['cube', 'coverflow', 'flip'].indexOf(s.params.effect) >= 0) {
            if (s.support.transforms3d) {
                s.params.watchSlidesProgress = true;
                s.classNames.push('container-3d');
            }
            else {
        ...
        if (s.params.effect !== 'slide') {
            s.classNames.push('container-' + s.params.effect);
        }
        ...
        if (s.rtl) {
            s.classNames.push('container-rtl');
        }
        ...
        if (s.params.slidesPerColumn > 1) {
            s.classNames.push('container-multirow');
        }
        
        // Check for Android
        if (s.device.android) {
            s.classNames.push('container-android');
        }
        ...
        s.updateClickedSlide = function (e) {
            ...
            if (s.params.slideToClickedSlide && s.clickedIndex !== undefined && s.clickedIndex !== s.activeIndex) {
                ...
                if (s.params.loop) {
                    ...
                    realIndex = $(s.clickedSlide).attr('data-slide-index');
                    if (s.params.centeredSlides) {
                        if ((slideToIndex < s.loopedSlides - s.params.slidesPerView/2) || (slideToIndex > s.slides.length - s.loopedSlides + s.params.slidesPerView/2)) {
                            s.fixLoop();
                            slideToIndex = s.wrapper.children('.' + s.params.slideClass + '[data-slide-index="' + realIndex + '"]:not(.slide-duplicate)').eq(0).index();
                            setTimeout(function () {
        ...
        s.destroyLoop = function () {
            s.wrapper.children('.' + s.params.slideClass + '.' + s.params.slideDuplicateClass).remove();
            s.slides.removeAttr('data-slide-index');
        };
        ...
        s.lazy = {
            ...
            loadImageInSlide: function (index, loadInDuplicate) {
                ...
                var img = slide.find('.lazy:not(.lazy-loaded):not(.lazy-loading)');
                if (slide.hasClass('lazy') && !slide.hasClass('lazy-loaded') && !slide.hasClass('lazy-loading')) {
                    img = img.add(slide[0]);
                }
                ...
                img.each(function () {
                    ...
                    s.loadImage(_img[0], (src || background), srcset, false, function () {
                        ...
                        _img.addClass('lazy-loaded').removeClass('lazy-loading');
                        slide.find('.lazy-preloader, .preloader').remove();
                        if (s.params.loop && loadInDuplicate) {
                            var slideOriginalIndex = slide.attr('data-slide-index');
                            if (slide.hasClass(s.params.slideDuplicateClass)) {
                                var originalSlide = s.wrapper.children('[data-slide-index="' + slideOriginalIndex + '"]:not(.' + s.params.slideDuplicateClass + ')');
                                s.lazy.loadImageInSlide(originalSlide.index(), false);
                            }
                            else {
                                var duplicatedSlide = s.wrapper.children('.' + s.params.slideDuplicateClass + '[data-slide-index="' + slideOriginalIndex + '"]');
        ...
        s.hashnav = {
            init: function () {
				...
				var temp_url = urltmp.replace(window.location.origin + '/anphaland_code', ""); 
		  		var tmp = temp_url.split('/');
				
				if(tmp.length>3){
					hash = window.location.origin + tmp[0] + '/' + tmp[1] + '/' + tmp[2] + '.html' ;
				}else{
					hash = window.location.origin + tmp[0] + '/' + tmp[1] + '/' + tmp[2] ;
				}
                ...
                for (var i = 0, length = s.slides.length; i < length; i++) {
					...
					var slideHash = slide.attr('data-href');
            ...
            setHash: function () {
				...
				var tmpurl = s.slides.eq(s.activeIndex).attr('data-href') || '';
			    var tmptitle = s.slides.eq(s.activeIndex).attr('data-title') || '';
			    var tmpkeyword = s.slides.eq(s.activeIndex).attr('data-keyword') || '';
			    var tmpdescription = s.slides.eq(s.activeIndex).attr('data-description') || '';
			    var tmpdataname = s.slides.eq(s.activeIndex).attr('data-hash') || '';
        ...
        function handleKeyboard(e) {
            ...
            if (kc === 37 || kc === 39 || kc === 38 || kc === 40) {
                ...
                if (s.container.parents('.item-container').length > 0 && s.container.parents('.item-active').length === 0) {
                    return;
                }
                var windowScroll = {
        ...
        s.a11y = {
            ...
            liveRegion: $('<span class="notification" aria-live="assertive" aria-atomic="true"></span>'),
