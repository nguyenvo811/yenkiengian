...
function SlidePicture() {
    ...
    /*ABOUT SERVICE PAGE*/
    if ($('.scroll-page, #services-page, #recruitment-page').length) {
        if ($(window).width() > 1100) {
    ...
    $(document).bind('scroll', function() {
        ...
        if ($(window).width() <= 1100) {
            ...
            if ($('.popup-pics-mobile img').length > 0) {
                ...
                var Margin = $('.js-detail').css('margin-top');
...
$(window).on('resize', function() {
    ...
    if ($(window).width() > 1100) {
        ...
        if ($('#project-details-page').length) {
            if (!$('.sub-menu li').hasClass('current')) {
                $('.sub-menu li:first-child a').trigger('click');
            } else {
                $('.sub-menu li.current a').trigger('click');
            }

            if ($('.content-house-slide').length && $('.s-mobile').length) {
                $('div .s-mobile').removeClass('s-mobile');
                $('.content-house-slide').data('BTQSlider').reinit();
            }
        ...
        if ($('#project-details-page').length) {
            if ($('.content-house-slide').length && $('.s-desktop').length) {
                $('div .s-desktop').removeClass('s-desktop');
                $('.content-house-slide').data('BTQSlider').reinit();
            }
        }
...
$(window).bind("popstate", function(e) {
    ...
    if ($(window).width() > 1100) {
        ...
        if (e.originalEvent.state !== null) {
            ...
            if ($('.scroll-page, #services-page').length) {
            ...
            if ($('#recruitment-page').length) {
                ...
                if (tmp_1[2] != '' && tmp_1[2] != undefined) {
                    if ($(".sub-nav li.current a").attr('href') != httpserver + tmp_1[0] + '/' + tmp_1[1] + '.html') {
                        $(".sub-nav li a[href='" + httpserver + tmp_1[0] + '/' + tmp_1[1] + '.html' + "']").trigger('click');
                    }
                    $(".link-career").each(function(index, element) {
                        if ($(element).attr('href') == tmp_url) {
                            $(element).trigger('click');
                        }
                    });

                } else if (tmp_1[1] != '' && tmp_1[1] != undefined) {
                    if ($('.detail-recruitment').length) {
                        $('.back').trigger('click');
                    }
                    $(".sub-nav li a").each(function(index, element) {
            ...
            if ($('#news-page').length) {
                ...
                if (tmp_1[2] != '' && tmp_1[2] != undefined) {
                    if ($(".sub-news li.current a").attr('href') != httpserver + tmp_1[0] + '/' + tmp_1[1] + '.html') {
                        $(".sub-news li a[href='" + httpserver + tmp_1[0] + '/' + tmp_1[1] + '.html' + "']").trigger('click');
                    }
                    ...
                    if (($(".sub-news li a[href='" + tmp_url + "']").attr('data-name') != 'videos' && $(".sub-news li a[href='" + tmp_url + "']").attr('data-name') != 'pictures')) {
                        window.history.back();
                    } else {
                        $(".sub-news li a[href='" + tmp_url + "']").trigger('click');
                    }
                } else {
                    window.history.back();
                }
            ...
            if ($('#news-page').length) {
                ...
                if (tmp_1[2] != '' && tmp_1[2] != undefined) {
                    ...
                    if (($(".sub-news li a[href='" + tmpurl + "']").attr('data-name') != 'videos' && $(".sub-news li a[href='" + tmpurl + "']").attr('data-name') != 'pictures')) {
                        window.history.back();
                    } else {
                        $(".sub-news li a[href='" + tmpurl + "']").trigger('click');
                    }
                } else {
                    window.history.back();
                }
