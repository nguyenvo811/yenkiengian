...
namespace FSite.Models.Data
{
    public class ProductCategory
    {
        ...
        {
            this.Items = new HashSet<ProductCategoryItem>();
            this.Subs = new HashSet<ProductCategory>();
        }
        public virtual ICollection<ProductCategoryItem> Items { get; set; }
        [Key]
        ...
        public virtual ICollection<ProductCategory> Subs { get; set; }
    }
}